...
if( isset($_POST['submit']) ){
        ...
        if(!empty(trim($name)) && !empty(trim($username)) && !empty(trim($nim)) && !empty(trim($password)) && !empty(trim($repass))){
            ...
            if($password == $repass){
                ...
                if( cek_nama($name,$con) == 0 ){
                    ...
                    $query = "INSERT INTO user (name, nim, username, password ) VALUES ('$name','$nim','$username','$pass')";
